...
const course: Course = {
  ...
  level: "Débutant",
  instructor: "Anaïs Verdier",
  instructorBio:
    "Anaïs Verdier a passé six ans comme community manager en agence avant de se mettre à son compte. Elle gère aujourd'hui la production de contenu de marques e-commerce avec une équipe de deux personnes là où il en fallait six, et forme des indépendants à faire pareil sans sacrifier leur voix.",
  hours: 5,
  rating: 4.7,
  learners: 1260,
  accent: "#a78bfa",
