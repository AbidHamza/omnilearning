...
const course: Course = {
  ...
  instructorBio:
    "Julien Vasseur est développeur freelance devenu indie hacker. Après deux produits abandonnés faute de clients, il a fini par en lancer deux qui tiennent : un outil de reporting pour agences et un plugin de facturation, environ 2 100 € de MRR cumulés au bout de deux ans. Il enseigne la version sans filtre : les échecs comptables inclus.",
  hours: 5,
  rating: 4.7,
  learners: 940,
  accent: "#38bdf8",
