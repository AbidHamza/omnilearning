...
const course: Course = {
  ...
  level: "Intermédiaire",
  instructor: "Antoine Rivière",
  instructorBio:
    "Antoine Rivière a passé six ans à monter des back-offices e-commerce avant de se spécialiser dans l'automatisation. Il maintient aujourd'hui une centaine de workflows n8n en production pour des TPE et des indépendants, et tient un carnet précis de ce que chaque workflow fait gagner (ou coûte) à ses clients.",
  hours: 6,
  rating: 4.7,
  learners: 920,
  accent: "#ea4b71",
